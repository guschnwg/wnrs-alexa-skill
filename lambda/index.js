...
const MainDeckIntentHandler = {
  ...
  async handle(handlerInput) {
    ...
    const speakOutput = "You are playing the main deck! " + question + " Always answer with: My answer is...";
...
const YesIntentHandler = {
  ...
  async handle(handlerInput) {
    ...
    sessionAttributes.currentQuestionId =
      sessionAttributes.levels[sessionAttributes.currentLevel][sessionAttributes.currentQuestionInLevel];

    handlerInput.attributesManager.setSessionAttributes(sessionAttributes);
    await handlerInput.attributesManager.setPersistentAttributes(sessionAttributes);

    const question =
      "Okay, here we go, next question: " + getQuestion(sessionAttributes.deck, sessionAttributes.currentQuestionId);

    return handlerInput.responseBuilder.speak(question).getResponse();
  },
};
...
const NoIntentHandler = {
  ...
  handle(handlerInput) {
    return handlerInput.responseBuilder.speak("Okay, come back later anytime!").getResponse();
  },
};
